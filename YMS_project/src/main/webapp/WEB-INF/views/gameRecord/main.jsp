...
<body>
	...
	$.ajax({
		...
		success : function(data) {
			if (data.length == 0){
				$("<img class='userTier'>").attr("src","resources/img/UNRANKED.png").appendTo("#summonerTier_div");
			}
			...
			$("<img class='userTier'>").attr("src","resources/img/"+userTier+".png").appendTo("#summonerTier_div");
