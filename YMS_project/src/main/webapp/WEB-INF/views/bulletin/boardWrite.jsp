...
<body>
    ...
    <div class="login-box">
        ...
        <table class="content-from">
            <tr>
                <td><input type="text" name="bb_title" placeholder="제목" class="title-box"></td>                
                <td><button type="submit" class="small_button">
                    <span>등록하기</span>
                </button></td>
                <td><button type="button" onclick="location.href='bbBulletinBoardMv'" class="small_button">
                    <span>글 목록</span>
                </button></td>
            </tr>
            <tr>
                <td colspan="3">
                    <textarea name="bb_content" cols="105" rows="20" placeholder="내용" class="content-box"></textarea>
                </td>
            </tr>
        </table>    
   	</div>
