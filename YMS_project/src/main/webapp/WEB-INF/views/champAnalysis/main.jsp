...
<div class="select-box">
	<div class="selectLane_wrapper">
		<button class="selectLane" data-code="ALL"><img src="resources/img/fill.png" width="40px" height="40px"></button>
		<button class="selectLane" data-code="TOP"><img src="resources/img/top.png" width="40px" height="40px" ></button>
		<button class="selectLane" data-code="JUNGLE"><img src="resources/img/jug.png" width="40px" height="40px"></button>
		<button class="selectLane" data-code="MIDDLE"><img src="resources/img/mid.png" width="40px" height="40px"></button>
		<button class="selectLane" data-code="BOTTOM"><img src="resources/img/bot.png" width="40px" height="40px"></button>
		<button class="selectLane" data-code="UTILITY"><img src="resources/img/sup.png" width="40px" height="40px"></button>
	</div>
