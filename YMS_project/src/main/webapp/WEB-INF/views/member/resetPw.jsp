...
<body>
	...
	<div class="login-box">
		...
		<form name="mmResetPwFrm" action="mmResetPw" method="post">
			<div class="user-box">
				<input type="text" id="m_id" name="m_id" required="" value="${searchedId}"> <label>Username</label>
			</div>
			<div class="user-box">
			...
			<div class="buttons">
        <button class="button" type="submit" id="m_pwResetBtn">
          <span>비밀번호 재설정</span>
        </button>
			</div>
</form>
